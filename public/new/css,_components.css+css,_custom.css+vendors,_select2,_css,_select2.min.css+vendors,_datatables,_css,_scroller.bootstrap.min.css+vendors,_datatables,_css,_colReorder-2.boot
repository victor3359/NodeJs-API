...
.has-success .form-control-success {
  background-image: url("data:image/svg+xml;charset=utf8,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 8 8'%3E%3Cpath fill='%2300bf86' d='M2.3 6.73L.6 4.53c-.4-1.04.46-1.4 1.1-.8l1.1 1.4 3.4-3.8c.6-.63 1.6-.27 1.2.7l-4 4.6c-.43.5-.8.4-1.1.1z'/%3E%3C/svg%3E"); }
...
.has-warning .form-control-warning {
  background-image: url("data:image/svg+xml;charset=utf8,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 8 8'%3E%3Cpath fill='%23ffa000' d='M4.4 5.324h-.8v-2.46h.8zm0 1.42h-.8V5.89h.8zM3.76.63L.04 7.075c-.115.2.016.425.26.426h7.397c.242 0 .372-.226.258-.426C6.726 4.924 5.47 2.79 4.253.63c-.113-.174-.39-.174-.494 0z'/%3E%3C/svg%3E"); }
...
.has-danger .form-control-danger {
  background-image: url("data:image/svg+xml;charset=utf8,%3Csvg xmlns='http://www.w3.org/2000/svg' fill='%23ff8080' viewBox='-2 -2 7 7'%3E%3Cpath stroke='%23d9534f' d='M0 0l3 3m0-3L0 3'/%3E%3Ccircle r='.5'/%3E%3Ccircle cx='3' r='.5'/%3E%3Ccircle cy='3' r='.5'/%3E%3Ccircle cx='3' cy='3' r='.5'/%3E%3C/svg%3E"); }
...
.btn {
  ...
  .btn:focus, .btn.focus {
    outline: 0;
    box-shadow: 0 0 0 2px rgba(0, 192, 239, 0.25); }
...
.btn-primary {
  ...
  .btn-primary:focus, .btn-primary.focus {
    box-shadow: 0 0 0 2px rgba(0, 192, 239, 0.5); }
...
.btn-info {
  ...
  .btn-info:focus, .btn-info.focus {
    box-shadow: 0 0 0 2px rgba(102, 140, 255, 0.5); }
...
.btn-success {
  ...
  .btn-success:focus, .btn-success.focus {
    box-shadow: 0 0 0 2px rgba(0, 191, 134, 0.5); }
...
.btn-warning {
  ...
  .btn-warning:focus, .btn-warning.focus {
    box-shadow: 0 0 0 2px rgba(255, 160, 0, 0.5); }
...
.btn-danger {
  ...
  .btn-danger:focus, .btn-danger.focus {
    box-shadow: 0 0 0 2px rgba(255, 128, 128, 0.5); }
...
.custom-control-input {
  ...
  .custom-control-input:focus ~ .custom-control-indicator {
    box-shadow: 0 0 0 1px #e9e9e9, 0 0 0 3px #00c0ef; }
...
.btn-mint {
  ...
  .btn-mint:focus, .btn-mint.focus {
    box-shadow: 0 0 0 2px rgba(15, 176, 192, 0.5); }
...
.btn-gray {
  ...
  .btn-gray:focus, .btn-gray.focus {
    box-shadow: 0 0 0 2px rgba(186, 196, 197, 0.5); }
...
.btn-mint-outline {
  ...
  .btn-mint-outline:hover {
    ...
    background-color: #0fb0c0;
    border-color: #0fb0c0; }
  .btn-mint-outline:focus, .btn-mint-outline.focus {
    box-shadow: 0 0 0 2px rgba(15, 176, 192, 0.5); }
  .btn-mint-outline.disabled, .btn-mint-outline:disabled {
    color: #0fb0c0;
    background-color: transparent; }
  .btn-mint-outline:active, .btn-mint-outline.active,
  .show > .btn-mint-outline.dropdown-toggle {
    color: #fff;
    background-color: #0fb0c0;
    border-color: #0fb0c0; }
...
a.bg-mint:focus, a.bg-mint:hover {
  background-color: #0b8591 !important; }

.bg-gray {
  background-color: #bac4c5 !important; }

a.bg-gray:focus, a.bg-gray:hover {
  background-color: #9eacae !important; }
...
.table_status_padding tr td span {
    padding: 3px 5px;
    border-radius: 3px;
}
.btn.info-stripe {
...
.dropdown_checkbox_margin_left {
    margin-left: -54px;
}

.table_status_padding .tag {
    padding: 4px 7px;
}
/* Form input sizing */
...
a[data-title]:hover:after {
    ...
    border-radius: 2px;
    background-image: -moz-linear-gradient(top, #2c2c2c, #424242);
    background-image: -webkit-gradient(linear, left top, left bottom, color-stop(0, #2c2c2c), color-stop(1, #424242));
    background-image: -webkit-linear-gradient(top, #2c2c2c, #424242);
    background-image: -moz-linear-gradient(top, #2c2c2c, #424242);
    background-image: -ms-linear-gradient(top, #2c2c2c, #424242);
    background-image: -o-linear-gradient(top, #2c2c2c, #424242);
}
...
.dataTables_paginate > ul > .active a:hover {
    color: #fff;
    background-color: #00c0ef;
}
...
@media (max-width: 1200px) {
    #editable_table_wrapper .fa-eye {
        margin-right: -3px;
    }
    #sample_5_wrapper .dataTables_scrollBody {
        width: 101.7% !important;
    }
}

.users_grid_tools .tools a,
.users_grid_tools .tools a:hover {
    background-color: #00c0ef !important;
...
.users_grid_tools .DTTT_button_print,
.paginate_button {
    cursor: pointer;
}
...
#editable_table_wrapper .dataTables_length label {
    margin-top: 15px;
}

#editable_table_wrapper #editable_table_filter {
    margin-top: 12px;
}
...
#editable_table .fa-eye,
#editable_table .fa-pencil {
    margin-right: -3px !important;
}

@media (min-width: 768px) and (max-width: 991px) {
    #editable_table_filter input {
        width: 100px;
    }
}

@media (max-width: 424px) {
    .table-toolbar .users_grid_tools {
        margin-top: 15px;
    }
}

#editable_table_wrapper .form-inline td .form-control {
    display: inline-block;
    width: 83%;
    padding-left: 6px;
    vertical-align: middle;
...
.paging_simple_numbers .disabled:hover,
.paging_simple_numbers .disabled a:hover {
    cursor: not-allowed;
}

@media (max-width:374px) {
    #editable_table_length {
        margin-left: -50px;
    }
}
...
.editable_data_table_width {
    width: 100% !important;
}

.editable_data_table_width .form-control {
    width: auto !important;
}
...
.tabletools-dropdown-on-portlet a {
    background-color: #00c0ef !important;
    color: #fff !important;
}

.tabletools-dropdown-on-portlet #ToolTables_sample_1_3 {
    border-top-right-radius: 0 !important;
    border-bottom-right-radius: 0 !important;
}

.tabletools-dropdown-on-portlet #ToolTables_sample_1_0 {
...
#row_details.dataTable, #row_details.dataTable th, #row_details.dataTable td {
    box-sizing: content-box;
}
#row_details.dataTable thead th, #row_details.dataTable thead td {
    padding: 10px 18px;
}
table.dataTable.dtr-inline.collapsed>tbody>tr>td:first-child:before, table.dataTable.dtr-inline.collapsed>tbody>tr>th:first-child:before{
    margin-top: 2px !important;
}
.tools_dropmenu_margin {
    margin-left: -78px;
}
...
@media (min-width:768px) {
    ...
    #sample_1_wrapper .dataTables_length,#user_body #editable_table_wrapper{
        margin-top: -35px;
    }
...
@media (max-width: 374px) {
    #user_body #editable_table_wrapper{
        margin-top: 12px;
    }
...
@media (max-width:380px){
    .simple .dataTables_paginate > ul > li{
...
@media (min-width: 768px) and (max-width: 830px) {
    .simple #example2_paginate .pagination{
        margin-left: -32px;
    }
}